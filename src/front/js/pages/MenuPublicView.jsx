    ...
    return (
        <div>
            ...
            <Container fluid className="m-1">
                <Row>
                    {menuList && restaurant_username && menu_id ? <MenuNavigation username={restaurant_username} menus={menuList} selected={menu_id} /> : <div>Cargando...</div>}
                </Row>
                            ...
                            {dishes && restaurant && menu ?
                                (<>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Subtitle> <Badge bg="light" className="p-3 text-dark">{restaurant.cuisine_type}</Badge> <GoogleMapsModal addressLink={restaurant.social_networks} /> {isLogged && <FavoriteButton dish_id={null} restaurant_id={restaurant.restaurant_id} />}</Card.Subtitle>
