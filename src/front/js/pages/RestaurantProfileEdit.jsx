...
import "../../styles/RestaurantProfileEdit.css"; 
...
const RestaurantProfileEdit = () => {
    ...
    return (
        <div>
            <RestaurantNavbar />
            <div className="restaurant-profile-edit-page">
                <div className="restaurant-profile-edit-container">
                    <h2 className="restaurant-profile-edit-title">EDITAR PERFIL DE RESTAURANTE</h2>
                    <Form className="restaurant-profile-edit-form">
                        ...
                        <Form.Group className="mb-3" controlId="Location">
                            ...
                            <Form.Select
                                ...
                                value={registration.department.id}
                                className="mb-2"
                            >
                        ...
                        <Form.Group className="mb-3" controlId="Image">
                            ...
                            <Widget
                                publicKey="47bd03853371888b5541"
                                onChange={handleFileChange}
                                value={registration.image}
                            />
                        </Form.Group>
                        <Button
                            className="restaurant-profile-edit-button"
                            type="submit"
